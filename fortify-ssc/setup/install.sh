...
function install { 
    ...
    FILE_BIRT=birt-report-designer-all-in-one-4_4_2-20150217.zip
    URL_BIRT=http://eclipse.c3sl.ufpr.br/birt/downloads/drops/R-R1-4_4_2-201502171805/${FILE_BIRT}
    ...
    if [ $DEBUG = "true" ]; then
        ...
        echo "FILE_SCA_LINUX_OPTIONS=${FILE_SCA_LINUX_OPTIONS}"
        echo "FILE_SCA_OSX_OPTIONS=${FILE_SCA_OSX_OPTIONS}"
        echo "FILE_SCA_WINDOWS_OPTIONS=${FILE_SCA_WINDOWS_OPTIONS}"
    ...
    mv fortify_sca_unattended_linux.options ${CATALINA_HOME}/webapps/ssc/downloads/${FILE_SCA_LINUX_OPTIONS}
    mv work/sca-linux/${FILE_SCA_LINUX} ${CATALINA_HOME}/webapps/ssc/downloads/
    ...
    mv fortify_sca_unattended_osx.options ${CATALINA_HOME}/webapps/ssc/downloads/${FILE_SCA_OSX_OPTIONS}
    mv work/sca-osx/${FILE_SCA_OSX} ${CATALINA_HOME}/webapps/ssc/downloads/
    ...
    mv FortifyInstallers/${FILE_BIRT} ${CATALINA_HOME}/webapps/ssc/downloads/

    FILE_INTELLIJ_REMEDIATION=Fortify_IntelliJ_Remediation_Plugin_${FORTIFY_SCA_MAJOR}.zip
    ...
    mv ${PATH_TO_INTELLIJ_REMEDIATION} ${CATALINA_HOME}/webapps/ssc/downloads/

    echo "*** Moving Other Installers to ${CATALINA_HOME}/webapps/ssc/downloads/ " 
    mv FortifyInstallers/${FILE_WI} ${CATALINA_HOME}/webapps/ssc/downloads/
    mv FortifyInstallers/${FILE_SECURITY_TOOLKIT} ${CATALINA_HOME}/webapps/ssc/downloads/
    mv FortifyInstallers/${FILE_RUNTIME_AGENT} ${CATALINA_HOME}/webapps/ssc/downloads/

    # Creating Update Site
    echo "*** Customizing SSC - Update-Site " 
    FILE_ECLIPSE_REMEDIATION=Fortify_Eclipse_Remediation_Plugin_${FORTIFY_SCA_MAJOR}.zip
    ...
    FILE_ECLIPSE_SECURITY_ASSISTANT=Fortify_SecurityAssistant_Eclipse_Plugin_${FORTIFY_SCA_MAJOR}.zip
    ...
    mv ${FORTIFY_SCA_MAJOR}-update.xml ${CATALINA_HOME}/webapps/ssc/update-site/installers/update.xml
    ...
    mv -f ${FORTIFY_SSC_MAJOR}-securityContext.xml ${CATALINA_HOME}/webapps/ssc/WEB-INF/internal/securityContext.xml
    ...
    mv -f ${FORTIFY_SSC_MAJOR}-serviceContext.xml ${CATALINA_HOME}/webapps/ssc/WEB-INF/internal/serviceContext.xml
