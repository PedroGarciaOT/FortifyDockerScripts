...
#Config Agent
Start-Process -FilePath "cmd.exe" -ArgumentList "/c", "config.cmd", "--unattended", "--url", $adourl, "--auth", "pat", "--token", $adopat, "--pool", $adopool, "--agent", $adoagent, "--replace", "--runAsService" -Wait -WorkingDirectory "C:\ADO-Agent"
